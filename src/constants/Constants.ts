...
export const Petlist: PetListType[] = [
  ...
  },
  {
    ...
    description:
      "개들 중에서 가장 작은 품종으로 유명하다. 얼굴형이 예쁘고 크기도 작아서 교배종으로도 인기가 많다. 예를 들어 암컷 치와와와 미니핀 사이에서 태어난 믹스견의 경우 미니핀의 각진 듯한 얼굴형이 치와와의 둥근 얼굴형으로 바뀌고, 흑갈색과 백색이 어우러진 독특한 외모로 신선한 느낌을 준다.",
    photourl:
  ...
  },
  {
    ...
    photourl:
      "https://firebasestorage.googleapis.com/v0/b/petmily-dab67.appspot.com/o/Pets%2F%E1%84%86%E1%85%B5%E1%84%82%E1%85%B5%E1%84%91%E1%85%B5%E1%86%AB.png?alt=media&token=ca29a934-e3ba-4a6b-aa25-ea7ea8fc286c",
  },
  {
    petSort: "강아지",
    name: "파피용",
    description:
      "스패니엘의 변종으로 스피츠 종과 섞여 개량된 품종이다. 귀가 오똑하게 서있는 모습을 뒤에서 바라보면 나비와 닮았다고 해서 빠삐용(Papillon)으로 불리게 되었다. 소형견 중에서는 토이 푸들 다음으로 똑똑하다. 단점이라면 지나치게 활발하면서 머리가 너무 좋아서 서열을 확실히 하지 않으면 말티즈처럼 주인 머리 위에 올라설 위험이 있다.",
    life: "12-15년",
    personality: [
      "강인한",
      "에너제틱한",
    ...
    photourl:
      "https://firebasestorage.googleapis.com/v0/b/petmily-dab67.appspot.com/o/Pets%2F%E1%84%91%E1%85%A1%E1%84%91%E1%85%B5%E1%84%8B%E1%85%AD%E1%86%BC.png?alt=media&token=2318002d-b147-4805-9f4a-1d4338a8c0c4",
  },
  {
    petSort: "강아지",
    name: "토이 푸들",
    description:
      "푸들은 본래 대형견이었으나 점차 작게 개량하여 작은 사이즈의 푸들이 널리 퍼졌고 이들을 그룹화 하면서 '스탠다드-미니어처'로 이분화 되기 시작한다. 그러다가 미니어처에서 좀 더 작은 집단을 구분하면서 '토이' 그룹까지 생겨난다.",
    life: "12-15년",
    personality: [
      "경계심이 많은",
      "총명한",
